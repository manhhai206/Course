...
Tính trừu tượng là những cái logic xử lý hay những cái đưa ra cái kết quả cuối cùng thì bị ẩn đi không cho user thấy, thì nó nằm trong method và method đó được xét ở private.

- Phương thức tinhNghiem() là  tính trừu tượng. Toàn bộ logic tính toán nghiệm của phương trình bậc hai được ẩn đi trong một phương thức private, không cho phép người dùng trực tiếp gọi hoặc chỉnh sửa.
```c
...
```
Người dùng chỉ cần sử dụng phương thức printResult() để nhận kết quả mà không cần biết chi tiết về cách chương trình tính toán.
```c
