...
- Con trỏ hằng là con trỏ dùng để trỏ đến một đối tượng khác có giá trị thay đổi được, nhưng địa chỉ con trỏ trỏ tới thì cố định không thể thay đổi.
...
Null Pointer là một con trỏ không trỏ đến bất kỳ đối tượng hoặc vùng nhớ cụ thể nào.Tránh việc con trỏ trỏ tới vùng nhớ không xác định.
